...
const PartnerBanner = () => {
  return (
    <div className="bg-white w-full py-10">
      {/* Increased to max-w-7xl for a much wider appearance */}
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        
        {/* The Card Section - Reduced shadow and border opacity for a cleaner look */}
        <div className="border border-gray-100 shadow-sm rounded-3xl p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="text-left max-w-3xl">
            {/* Font size base-lg with slightly tighter tracking for that modern look */}
          ...
          {/* Button color matched to the bright pink in your screenshot */}
